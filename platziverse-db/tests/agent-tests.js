...
let usernameArgs = {
  where: { username: single.name, connected: true }
}
...
test.beforeEach(async () => {
  ...
  AgentStub.findByUsername.withArgs(single.name).returns(Promise.resolve(single))

  // Model findByUuid Stub
  AgentStub.findByUuid = sandbox.stub()
  AgentStub.findByUuid.withArgs(uuidArgs).returns(Promise.resolve(agentFixtures.byUuid(single.uuid)))
  ...
  AgentStub.findOne.withArgs(uuidArgs).returns(Promise.resolve(agentFixtures.byUuid(single.uuid)))
